...
#include "ExcecaoDeInfraestrutura.h"        //#22 SCM SMP
#include "pttnaocadastrado.h"               //#26 SCM SMP
#include "ModeloHardwareNaoCompativel.h"    //#29 SCM
...
int main()
{
    ...
    vector<string> listaHardwareCompativel;
    listaHardwareCompativel.push_back("otavio");
    listaHardwareCompativel.push_back("pellicano");


    if(opmm::ModeloHardwareNaoCompativel("otavio", listaHardwareCompativel).medicaoValida())
    {
        qDebug() << "(Hardware Compativel) encontrado!";
    }
    else
    {
        qDebug() << "(Hardware Compativel) NAO encontrado!";
    }
    ...
    if(opmm::ExcecaoDeInfraestrutura("192.168.0.4", dateTimeAtual, dateTimeInicio,
                                     dateTimeFim,listaExcecaoInfra).medicaoValida())
    {
        qDebug() << "(Lista de Excecao) Medida Valida";
    }
    else
    {
        qDebug() << "(Lista de Excecao) Medida INVALIDA";
    }
